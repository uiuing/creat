...
export declare type PlotType = 'selection' | 'rectangle' | 'diamond' | 'triangle' | 'circle' | 'line' | 'arrow' | 'arbitrary-plot' | 'text' | 'image' | 'eraser';
...
export declare type NodeArray = Array<Node>;
export declare type Node = {
    ...
    singleRender?: (mx: number, my: number, tx: number, ty: number, lineWidth: number) => void;
